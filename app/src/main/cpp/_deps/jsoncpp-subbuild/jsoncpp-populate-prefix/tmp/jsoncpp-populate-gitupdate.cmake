...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "1.9.5"
  WORKING_DIRECTORY "/Users/kevinyu/Projects/mobile-ai/app/src/main/cpp/_deps/jsoncpp-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 1.9.5")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/kevinyu/Projects/mobile-ai/app/src/main/cpp/_deps/jsoncpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/kevinyu/Projects/mobile-ai/app/src/main/cpp/_deps/jsoncpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
